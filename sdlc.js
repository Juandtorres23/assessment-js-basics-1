...
const analysisOfRequirements = "This is the second step, in which you determin user expectations for a new or modified product."

const design = "This is the third step, this is the process of defining software methods, functions, objects, and the overall structure and interaction of your code so that the resulting functionality will satisfy your users requirements."

const implementation = "This is the fourth step, this is the processes and procedures needed to take software applications and tools from planning and development to the production stage."

const testingAndIntegration = "This is the fifth step, in which the different units, modules or components of a software application are tested as a combined entity."
